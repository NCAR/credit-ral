...
MASTER_ADDR=$head_node_ip MASTER_PORT=1234 mpiexec -n 1 --ppn 1 --cpu-bind none python /glade/u/home/ksha/credit-mini/applications/WRF_pred_future_subset.py -c model_pred.yml
