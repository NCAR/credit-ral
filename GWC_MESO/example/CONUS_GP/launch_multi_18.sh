...
MASTER_ADDR=$head_node_ip MASTER_PORT=1234 mpiexec -n 32 --ppn 4 --cpu-bind none python /glade/u/home/ksha/DWC-WRF/applications/train_WRF_multi.py -c /glade/work/ksha/DWC_runs/CONUS_GP_ERA5/model_multi_18.yml --backend nccl
