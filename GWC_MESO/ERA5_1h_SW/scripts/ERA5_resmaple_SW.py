...
# ==================================================================================== #
fn_1h = '/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_SW/dscale_1h/ERA5_SW_1h_{}.zarr'
...
savename_3h = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_SW/dscale_3h/ERA5_SW_3h_{year}.zarr'
ds_3h.to_zarr(savename_3h, mode='w', consolidated=True, compute=True, encoding=dict_encoding)

savename_6h = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_SW/dscale_6h/ERA5_SW_6h_{year}.zarr'
