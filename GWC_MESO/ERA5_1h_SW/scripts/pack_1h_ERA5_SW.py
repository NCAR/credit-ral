...
fn_1h_upper = '/glade/campaign/ral/hap/ksha/ERA5_data_SW/upper_air/ERA5_plevel_1h_upper_air_{}.zarr'
fn_1h_surf = '/glade/campaign/ral/hap/ksha/ERA5_data_SW/surf/ERA5_plevel_1h_surf_{}.zarr'
# fn_1h_land = '/glade/campaign/ral/hap/ksha/ERA5_data_SW/land/ERA5_plevel_1h_land_{}.zarr'
...
# ST = ds_year['soil_temperature_level_1']
# SW = ds_year['volumetric_soil_water_layer_1']

# ST = ST.where(LANDMASK != 0)
# SW = SW.where(LANDMASK != 0)

# ds_year['soil_temperature_level_1'] = ST
# ds_year['volumetric_soil_water_layer_1'] = SW
...
save_name = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_SW/dscale_1h/ERA5_SW_1h_{year}.zarr'
