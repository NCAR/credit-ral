...
for i in range(L):
    ...
    ds_mlevel = ds_mlevel.isel(west_east=slice(905, 1240+1, 1), south_north=slice(290, 625+1, 1))
    ...
    save_name = '/glade/campaign/ral/hap/ksha/DWC_data/CONUS_domain_SW/raw_404/' + 'C404_SW_' + fn_2d[-22:-9] + 'H.zarr'
    print(save_name)
