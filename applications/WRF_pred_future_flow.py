...
def adjust_to_reference(
    ...
    Optional sign-lock on wind channels: where the corrected prediction
    disagrees in sign with the reference (in physical units), clip to zero.
    See the trainer module for the longer explanation.
    """
