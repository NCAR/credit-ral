...
def main(rank, world_size, conf, backend, trial=False, profiler=None):
    """
    ...
    if profiler is not None:
        profiler.add_function(trainer.fit)
...
if __name__ == "__main__":
    ...
    # Add the function(s) you want to profile
    profiler.add_function(main)

    # Wrap the main execution with the profiler
    def profiled_main():
        ...
        main(world_rank, world_size, conf, backend, profiler=profiler)

    # Run the profiled main function
    profiler.runcall(profiled_main)
