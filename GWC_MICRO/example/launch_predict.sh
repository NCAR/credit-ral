...
MASTER_ADDR=$head_node_ip MASTER_PORT=1234 mpiexec -n 4 --ppn 4 --cpu-bind none python /glade/u/home/ksha/credit-mini/applications/LES_pred.py -c model_predict.yml
